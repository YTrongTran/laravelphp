...
Route::group(['prefix' => 'kieuthi'], function () {
    ...
    Route::post('/delete/{id}', 'QlsvKieuthiController@destroy');
});
...
//----------------TuDanhGiasinhvien------------------
Route::group(['prefix' => 'tudanhgiasinhvien'], function () {
    Route::get('/index', 'QlsvTudanhgiasinhvienlophocController@index')->name('qlsv_tudanhgiasv.index');
    Route::get('/create', 'QlsvTudanhgiasinhvienlophocController@create')->name('qlsv_tudanhgiasv.create');
    Route::post('/store', 'QlsvTudanhgiasinhvienlophocController@store')->name('qlsv_tudanhgiasv.store');
    Route::get('/edit/{id}', 'QlsvTudanhgiasinhvienlophocController@edit')->name('qlsv_tudanhgiasv.edit');
    Route::post('/update', 'QlsvTudanhgiasinhvienlophocController@update')->name('qlsv_tudanhgiasv.update');
    Route::post('/delete/{id}', 'QlsvTudanhgiasinhvienlophocController@destroy')->name('qlsv_tudanhgiasv.delete');
    Route::get('/find', 'QlsvTudanhgiasinhvienlophocController@search')->name('qlsv_tudanhgiasv.search');
});