...
<header class="row logo">
    ...
    <div class="col-sm-8 shopping-mall">
        <h2
            style=" margin-top: 48px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color: #fff;">
...
<body>
    ...
    <nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large"
        style="display:none; top: 0;" id="mySidebar">
        ...
        <a href="{{route('qlsv_sinhvien.index')}}" onclick="w3_close()" class="w3-bar-item w3-button">Quản lý sinh
            viên</a>
        <a href="{{route('qlsv_giangvien.index')}}" onclick="w3_close()" class="w3-bar-item w3-button">Quản lý giảng
            viên</a>
        <a href="{{route('qlsv_khoahoc.index')}}" onclick="w3_close()" class="w3-bar-item w3-button">Quảng lý khoá
            học</a>
        <a href="{{route('qlsv_diemthi.index')}}" onclick="w3_close()" class="w3-bar-item w3-button">Quản lý điểm</a>
        <div class="dropdown">
        ...
        <a href="{{route('qlsv_worktask.index')}}" onclick="w3_close()" class="w3-bar-item w3-button">Quản lý
            WorkTask</a>
        <a href="{{route('qlsvlophoc.index')}}" onclick="w3_close()" class="w3-bar-item w3-button">Quản lý lop
            hoc</a>
